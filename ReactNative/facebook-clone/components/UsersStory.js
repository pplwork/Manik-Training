...
const UsersStory = () => {
    return (
        ...
        <View style={styles.container}>
            ...
            >
                <View style={{...styles.card , marginLeft: 11}}><MyStory/></View>
                {stories.map((story)=>{
                    return <View style={styles.card} key={story.source}><OtherStory source={story.source} isSeen={story.isSeen} Profile={story.Profile} Name={story.Name} /></View>
                })}
            </ScrollView>
        </View>
