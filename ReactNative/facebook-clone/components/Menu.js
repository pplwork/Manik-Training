...
const menu = [
  {
    source: require("../assets/notiWatch.png"),
    text: "Videos on Watch",
    notCount: null,
  },
  { source: require("../assets/saved.png"), text: "Saved", notCount: null },
  {
    source: require("../assets/notiMarketplace.png"),
    text: "Marketplace",
    notCount: 1,
  },
...
const Menu = (props) => {
  ...
  const handleLogout = () => {
    dispatch(logout());
    props.StackNavigation.navigate("login");
  };
  useEffect(() => {
    if (isFocused)
        ...
        <View style={styles.menuHeader}>
          ...
          <View style={{ ...styles.WatchRow, justifyContent: "flex-start" }}>
            ...
            <View style={styles.descContainer}>
              ...
              <Text style={{ color: "#606770", fontSize: 14 }}>
                See your profile
              </Text>
            </View>
          </View>
        ...
        <View style={styles.utilityContainer}>
          ...
          <View style={{ ...styles.WatchRow, justifyContent: "flex-start" }}>
            <View style={styles.WatchButton}>
              <FontAwesome5 name="question" size={14} color="black" />
            </View>
            <Text
              style={{
                color: "#000000",
          ...
          <TouchableOpacity
            style={{ ...styles.PublicDetails, backgroundColor: "#E4E6EB" }}
